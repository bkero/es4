...
datatype block = 
	 Block of { directives: directive list,
     ...
     and primTy = 
	 PrimTy of { name: ident, 
		     annotation: primAnnotation }
		   
     and funcTy = 
	 FuncTy of { paramTypes: tyExpr list,
		     returnType: tyExpr,
