...
and parameter (ts) (n) : ((TOKEN * Ast.POS) list * (Ast.BINDING * {pattern:PATTERN, ty:Ast.TYPE_EXPR option})) =
...
and restParameter (ts) (n): ((TOKEN * Ast.POS) list * (Ast.BINDINGS * Ast.EXPR list)) =
