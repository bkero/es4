...
\newcommand{\wrapv}[2]{#1~\t{wrappedXXXXXXXX}~#2}
%\renewcommand{\wrapv}[2]{\wrap{#1}{#2}}
 
\newcommand{\wrap}[2]{#1~\t{wrapXXXXXXXXXXXXX}~#2}
%\newcommand{\assignable}[2]{#1<#2}
\newcommand{\likev}[2]{#1 \sqsubset_{\sigma XXXXXXXXXXX} #2 }
\renewcommand{\likev}[2]{#1 ~\fun{XXXX like}_{\sigmaXXXXXXXXXXXX}~ #2 }
...
We now extend the language and type language with implicit int-to-boolean conversions:
\[
\begin{array}{llr}
