...
\begin{displayfigure}{th}{Matching and Consistency}
\label{fig:convert}
\begin{trules}
...
The relation $\matches S T$ holds if there exists $U$ such that $\subtype S U$ and $\consistent U T$. 
...
\comsubtype S T		&\mbox{Compatible-subtyping} & \mbox{Transitive, reflexive, $\subtype{}{}\circ\compatible{}{}$}\\
\implies S T 			&\mbox{Implies}			&\mbox{Transitive, irreflexive, used for optimization}\\
\consistent S T			&\mbox{Consistency (Siek-Taha)}		&\mbox{Intransitive, reflexive, symmetric, $\consistent T \dynamic$ and $\consistent \dynamic T$} \\
\matches S T			&\mbox{Matches}				&\mbox{$\subtype{}{}\circ\consistent{}{}$ plus extras, used in strict mode}\\
