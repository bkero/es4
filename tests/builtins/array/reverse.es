...
writeHeaderToLog( SECTION + " Array.reverse()");
...
new TestCase( SECTION,
	      "var A=new Array(true,false,null);  Array.reverse(A); A.length",
	      R.length,
	      eval( S + "; Array.reverse(A); A.length") );
...
new TestCase( SECTION,
	      "var new Array(true,false,null,void 0);  A.reverse(); A.length",
	      R.length,
	      eval( S + "; A.reverse(); A.length") );
CheckItems( R, A );
...
var R = Reverse(A);
new TestCase( SECTION,
	      "var A=new Array();A[8]='hi',A[3]='yo';  Array.reverse(A); A.length",
	      R.length,
	      eval( S + "; Array.reverse(A); A.length") );
CheckItems( R, A );
...
function CheckItems( R, A ) {
    new TestCase(
      SECTION,
      "Check Array Items test, comparing arrays ["+A.toString()+"] with expected reversed array",
      R.toString(),
      A.toString() );
}
