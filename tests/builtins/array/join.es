...
new TestCase( SECTION, "Array.prototype.join.length",           0,      Array.prototype.join.length );
...
new TestCase(   SECTION,
		"var TEST_ARRAY = new Array(); Array.join(TEST_ARRAY)",
		"",
		eval("var TEST_ARRAY = new Array(); Array.join(TEST_ARRAY)") );
...
new TestCase(   SECTION,
		"var TEST_ARRAY = new Array(null, void 0, true, false, 123, new Object(), new Boolean(true) ); Array.join(TEST_ARRAY)",
		",,true,false,123,[object Object],true",
		eval("var TEST_ARRAY = new Array(null, void 0, true, false, 123, new Object(), new Boolean(true) ); Array.join(TEST_ARRAY)") );
...
new TestCase( SECTION, 
	      "Array.join(TEST_ARRAY,"+SEPARATOR+")",   
	      TEST_RESULT,    
	      Array.join(TEST_ARRAY,SEPARATOR ) );
...
new TestCase(   SECTION,
		"var OB = new Object_1('true,false,111,0.5,1.23e6,NaN,void 0,null'); Array.join(OB,':')",
		"true:false:111:0.5:1230000:NaN::",
		eval("var OB = new Object_1('true,false,111,0.5,1.23e6,NaN,void 0,null'); Array.join(OB,':')") );
