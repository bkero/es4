...
new TestCase( SECTION,
              "var array = new Array(1,2,3,...,2^10); arr.length",
              1024,
              eval("var arr = new Array("+ARGUMENTS+"); arr.length")
            );
new TestCase( SECTION,
              "var array = new Array(1,2,3,...,2^10); arr[1023]",
              1023,
              eval("var arr = new Array("+ARGUMENTS+"); arr[1023]")
            );
test();
